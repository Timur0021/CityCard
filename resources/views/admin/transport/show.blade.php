...
<html>
	...
	<body>
		...
		<div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 5rem;">Info about this Transport</h3>
            ...
            <table class="table table-hover text-nowrap">
                <tbody>
                    ...
                    <tr>
                        <td>Image</td>
                        <td><img src="{{ url('storage/' . $transport->image) }}" class="w-1 mb-3" style="width: 4rem;"></td>
                    </tr>
                    <tr>
                      <td>Date of Updated</td>
                      <td>{{ $transport->updated_at }}</td>
                    </tr>
                    <tr>
                        <td>Update</td>
                        <td>
                            <a href="{{ route('home.trantsport.transport.edit', $transport->id) }}">
                    ...
                    <tr>
                        <td>Delete</td>
                        <td>
                            <form action="{{ route('home.trantsport.transport.delete', $transport->id) }}" method="POST">
                                @csrf
                                @method('delete')
