...
<html>
	...
	<body>
		...
		<div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 5rem;">Info about this City</h3>
            ...
            <table class="table table-hover text-nowrap">
                <tbody>
                    ...
                    <tr>
                        <td>Update</td>
                        <td>
                            <a href="{{ route('home.city.city.edit', $city->id) }}">
                    ...
                    <tr>
                        <td>Delete</td>
                        <td>
                            <form action="{{ route('home.city.city.delete', $city->id) }}" method="POST">
                                @csrf
                                @method('delete')
