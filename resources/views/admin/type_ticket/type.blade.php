...
<html>
	...
	<body>
		...
		<div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 1rem;">Type Ticket</h3>
            <p style="text-align: center;;padding-bottom: 5rem;">Here is a list of Types ticket for trips</p>

            <a href="{{ route('home.type.type.cteate') }}">
                ...
                <tbody>
                    @foreach ($typeTicket as $typeTickets)
                        <tr>
                            ...
                            <th scope="row">{{ $typeTickets->ticket_type }}</th>
                            <th scope="row">{{ $typeTickets->ticket_price }}$</th>
                            <th scope="row">{{ $typeTickets->created_at }}</th>
                            <th scope="row"><a href="{{ route('home.type.type.show', $typeTickets->id) }}"><button class="btn btn-outline-primary" type="submit">Редагувати</button></a></th>
                        </tr>
                    @endforeach
                </tbody>
            </table>
