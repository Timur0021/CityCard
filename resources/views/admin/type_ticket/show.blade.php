...
<html>
	...
	<body>
		...
		<div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 5rem;">Info about this Type Ticket</h3>
            ...
            <table class="table table-hover text-nowrap">
                <tbody>
                    ...
                    <tr>
                        <td>Type Ticket</td>
                        <td>{{ $type->ticket_type }}</td>
                    </tr>
                    <tr>
                        <td>Ticket Price</td>
                        <td>{{ $type->ticket_price }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Update</td>
                        <td>
                            <a href="{{ route('home.type.type.edit', $type->id) }}">
                    ...
                    <tr>
                        <td>Delete</td>
                        <td>
                            <form action="{{ route('home.type.type.delete', $type->id) }}" method="POST">
                                @csrf
                                @method('delete')
