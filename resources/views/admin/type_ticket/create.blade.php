...
<html>
    ...
    <body>
        ...
        <div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 3rem;">Create Type</h3>
            <div class="card-header">
                <h3 class="card-title">Type Tiket</h3>
            </div>
            <form action="{{ route('home.type.type.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Type Ticket</label>
                        <input type="text" name="ticket_type" class="form-control" id="exampleInputEmail1" placeholder="Enter transport name" value="{{ old('ticket_type') }}">
                    </div>
                    @error('ticket_type')
                    ...
                    @enderror
                    <div class="form-group">
                        <label for="exampleInputFile">Price Ticket</label>
                        <div class="input-group mb-3">
                            <span class="input-group-text">$</span>
                            <input type="text" name="ticket_price" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ old('ticket_price') }}">
