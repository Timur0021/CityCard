...
<html>
    ...
    <body>
        ...
        <div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 3rem;">Update Type</h3>
            <div class="card-header">
                <h3 class="card-title">Update Tiket</h3>
            </div>
            <form action="{{ route('home.type.type.update', $type->id) }}" method="POST">
                @csrf
                @method('patch')
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Type Ticket</label>
                        <input type="text" name="ticket_type" class="form-control" id="exampleInputEmail1" placeholder="Enter transport name" value="{{ $type->ticket_type }}">
                    </div>
                    @error('ticket_type')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="ticket_price" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ $type->ticket_price }}">
