...
<html>
	...
	<body>
		...
		<div class="main-container">
            <h3 style="text-align: center; padding-top: 3rem;padding-bottom: 3rem;">Create Card</h3>

            <div class="card-header">
                <h3 class="card-title">ADD Card</h3>
            </div>
            <form action="{{ route('client.card.card.store') }}" method="POST">
                @csrf
                    <form class="row g-3">
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Card Number</label>
                            <input type="text" name="card_number" class="form-control" id="inputEmail4" value="{{ old('card_number') }}">
                        </div>
                        @error('card_number')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="balance" class="form-control" id="inputCity" value="{{ old('balance') }}">
                        </div>
                        @error('balance')
                            <div class="d-block text-danger">
                                {{ $message }}
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="cvc" class="form-control" id="inputZip" value="{{ old('cvc') }}">
                        </div>
                        @error('cvc')
                            <div class="d-block text-danger">
                                {{ $message }}
